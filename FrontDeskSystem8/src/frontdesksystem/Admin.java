...
public class Admin extends javax.swing.JFrame {
    ...
    private void showBillActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showBillActionPerformed
        ...
        // Prepare SQL queries
        String queryTimeServices = "SELECT EmployeeName, Time FROM time";
        String queryAvailServices = "SELECT servicename, serviceprice FROM availservices";

        try {
            // Execute the query to fetch product purchase data
            pst = con.prepareStatement(queryTimeServices);
            rs = pst.executeQuery();
            ...
            while (rs.next()) {
                ...
                billField.append("Employee Name: " + employeeName + ", Time: " + time + "\n");
            }
